  ...
  const work: WorkItem[] = [
    {
      ...
      description:
        "Discuss opportunities, data projects, and professional networking.",
      type: "link",
      href: portfolioConfig.socials.linkedin,
      boxClassName:
        "bg-linear-to-b from-blue-500 to-blue-700 ring-offset-blue-500",
      skeleton: (
    ...
    },
    {
      title: "Direct Email",
      description:
        "Click to copy yuvrajsrsingh@gmail.com directly to clipboard.",
      type: "copyEmail",
      email: portfolioConfig.workWithMe.email,
      boxClassName:
